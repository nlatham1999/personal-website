...
const About = () => {
    ...
    return (
        ...
        <div className='content'>
            <p>Current status: Working my way through <a href="https://adventofcode.com/">Advent Of Code</a> and <a href="https://en.wikipedia.org/wiki/G%C3%B6del%2C_Escher%2C_Bach">Gödel, Escher, Bach</a> and creating cool shit</p>
            <h>About Me</h>
